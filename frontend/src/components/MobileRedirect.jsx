 ...
 */
export default function MobileRedirect({ children, mobilePath = '/mobile', desktopPath = '/museum/chat' }) {
  ...
  useEffect(() => {
    ...
    if (isMobile && !currentPath.includes('/mobile') && currentPath === '/museum/chat') {
